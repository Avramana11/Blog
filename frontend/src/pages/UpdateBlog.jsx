...
const UpdateBlog = () => {
    ...
    const updateBlogHandler = async () => {
        ...
        try {
            setLoading(true)
            const res = await axios.put(`${API_BASE}/api/v1/blog/${id}`, formData, {
                headers: {
    ...
    const togglePublishUnpublish = async (action) => {
        ...
        try {
            const res = await axios.patch(`${API_BASE}/api/v1/blog/${id}`, null, {
    ...
    const deleteBlog = async () => {
        try {
            const res = await axios.delete(`${API_BASE}/api/v1/blog/delete/${id}`, { withCredentials: true })
            if (res.data.success) {
